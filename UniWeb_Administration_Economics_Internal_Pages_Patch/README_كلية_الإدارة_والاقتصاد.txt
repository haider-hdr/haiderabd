...
لا تستبدل الصفحة الرئيسية، ولا تنشئ Migration، ولا تعدل Models أو Controllers أو Routes، ولا تؤثر على بقية الكليات أو عناصر قائمة الكلية الواقعة خارج فرع "عن الكلية".
...
3) إعادة بناء فرع قائمة "عن الكلية" فقط بحيث:
   - ترتبط الصفحات بواسطة PageId الداخلي.
   - يظهر الاعتماد الأكاديمي بقائمة فرعية من المستوى الثالث.
   - لا تبقى روابط تشغيل إلى account.hilla-unc.edu.iq داخل هذا الفرع.
   - لا تتغير عناصر الأخبار أو الخدمات أو الكادر أو أي فرع آخر من قائمة الكلية.
...
ملاحظات مهمة
------------
- السكربت يحذف ويعيد إنشاء أبناء فرع "عن الكلية" التابع لكلية الإدارة والاقتصاد فقط.
...
- صفحتا مستجدات وأجندة الاعتماد مجهزتان للنشر، ولم تُضف إليهما تواريخ أو أرقام اعتماد غير موثقة.
- صفحة مجلس الكلية لا تتضمن أسماء أعضاء غير موثقة ويمكن تحديثها من لوحة CMS.
- يجب أن تكون قيمة ExternalLinksRemainingInAboutBranch في سكربت التحقق مساوية إلى 0.
